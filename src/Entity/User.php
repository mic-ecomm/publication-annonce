...
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="Vous pouvez renseigner votre nom de famille")
     * 
     */
    private $lastName;
     ...
     * @Assert\Url(message="Donner une URL valide pour votre avatar !")
     * 
     */
    private $picture;
    ...
    /**
     *@Assert\EqualTo(propertyPath="hash", message="Vous n'avez pas correctement configuré votre mot de passe !")
     */
